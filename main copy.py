...
def retrieval(user_ques: str, rasa_response: str, chat_history: list) -> str:
    ...
    try:
        ...
        custom_prompt_template = """
            Bạn tên 'CTUMP',chatbot của ĐH Y DƯỢC CẦN THƠ,dựa vào Context được cung cấp, trả lời câu hỏi.
            Nếu KHÔNG TÌM THẤY CÂU TRẢ LỜI trong Context, hãy nói 'Tôi không có thông tin'. 
            Tuyết đối KHÔNG được trả lời câu hỏi bằng kiến thức bên ngoài và KHÔNG trả lời thông tin ngoài Context.
